...
# write.csv(aucRF, "AUCLasso_RF_NetFeatures_LogBased_V0_Pre.csv")
# write.csv(aucSVM, "AUC_Lasso_SVM_NetFeatures_LogBased_V0_Pre.csv")

# write.csv(aucRF, "AUCLasso_RF_NetFeatures_LogBased_V0_Early.csv")
# write.csv(aucSVM, "AUC_Lasso_SVM_NetFeatures_LogBased_V0_Early.csv")

# write.csv(aucRF, "AUCLasso_RF_NetFeatures_LogBased_V0_Late.csv")
# write.csv(aucSVM, "AUC_Lasso_SVM_NetFeatures_LogBased_V0_Late.csv")
