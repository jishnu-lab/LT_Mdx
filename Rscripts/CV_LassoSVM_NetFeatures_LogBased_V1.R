...
# write.csv(aucRF, "AUCLasso_RF_NetFeatures_LogBased_V1_Pre.csv")
# write.csv(aucSVM, "AUC_Lasso_SVM_NetFeatures_LogBased_V1_Pre.csv")

# write.csv(aucRF, "AUCLasso_RF_NetFeatures_LogBased_V1_Early.csv")
# write.csv(aucSVM, "AUC_Lasso_SVM_NetFeatures_LogBased_V1_Early.csv")
